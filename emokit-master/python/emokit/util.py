...
values_header = "F3 Value,FC5 Value,F7 Value,T7 Value,P7 Value," \
                "O1 Value,O2 Value,P8 Value,T8 Value,F8 Value," \
                "AF4 Value,FC6 Value,F4 Value,AF3 Value,\n"
...
def writer_task_to_line(next_task):
    return "{f3_value},{fc5_value},{f7_value}," \
           "{t7_value},{p7_value},{o1_value}," \
           "{o2_value},{p8_value},{t8_value}," \
           "{f8_value},{af4_value},{fc6_value}," \
           "{f4_value},{af3_value},\n".format(
